...
$asmaAllah = [
    ...
    'اَلْعَلِيْمُ', 'الْقَابِضُ', 'الْبَاسِطُ', 'الْخَافِضُ', 'الرَّافِعُ', 'الْمُعِزُّ',
    'المُذِلُّ', 'السَّمِيعُ', 'الْبَصِيرُ', 'الْحَكَمُ', 'الْعَدْلُ', 'اللَّطِيفُ',
    'الْخَبِيرُ', 'الْحَلِيمُ', 'الْعَظِيمُ', 'الْغَفُورُ', 'الشَّكُورُ', 'الْعَلِيُّ',
    'الْكَبِيرُ', 'الْحَفِيظُ', 'المُقيِت', 'الْحسِيبُ', 'الْجَلِيلُ', 'الْكَرِيمُ',
    ...
    'اَلْمُمِيتُ', 'الْحَيُّ', 'الْقَيُّومُ', 'الْوَاجِدُ', 'الْمَاجِدُ', 'الْواَحِدُ',
    'اَلاَحَدُ', 'الصَّمَدُ', 'الْقَادِرُ', 'الْمُقْتَدِرُ', 'الْمُقَدِّمُ', 'الْمُؤَخِّرُ',
    'الأوَّلُ', 'الآخِرُ', 'الظَّاهِرُ', 'الْبَاطِنُ', 'الْوَالِي', 'الْمُتَعَالِي',
    'الْبَرُّ', 'التَّوَابُ', 'الْمُنْتَقِمُ', 'العَفُوُّ', 'الرَّؤُوفُ', 'مَالِكُ الْمُلْكِ',
    'ذُوالْجَلاَلِ وَالإكْرَامِ', 'الْمُقْسِطُ', 'الْجَامِعُ', 'الْغَنِيُّ', 'الْمُغْنِي', 'اَلْمَانِعُ',
    'الضَّارَّ', 'النَّافِعُ', 'النُّورُ', 'الْهَادِي', 'الْبَدِيعُ', 'اَلْبَاقِي',
...
<div class="container my-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center py-5">
            ...
            <?php else: ?>
                <img 
                    src="<?= BASE_URL ?>/assets/images/placeholder-memorial.svg" 
                    alt="صورة افتراضية"
                    class="memorial-image mb-3"
                    style="width: 180px; height: 180px;"
                >
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="alert alert-info">
                        <p class="mb-0">
                            ...
                            اللهم اغفر <?= getPronoun($memorial['gender'], 'له') ?> وارحم<?= getPronoun($memorial['gender'], 'له') ?>، 
                            وعاف<?= getPronoun($memorial['gender'], 'عنه') ?> واعف <?= getPronoun($memorial['gender'], 'عنه') ?>، 
                            وأكرم نزل<?= getPronoun($memorial['gender'], 'له') ?>، ووسع مدخل<?= getPronoun($memorial['gender'], 'له') ?>، 
                ...
                <div class="col-md-6">
                    <div class="alert alert-info">
                        <p class="mb-0">
                            <strong>🤲 دعاء:</strong><br>
                            اللهم أبدل<?= getPronoun($memorial['gender'], 'له') ?> داراً خيراً من دار<?= getPronoun($memorial['gender'], 'له') ?>، 
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <p class="text-center mb-4">
                🌿 هب ثواب هذه القراءة للمغفور <?= getPronoun($memorial['gender'], 'له') ?> <strong><?= e($memorial['name']) ?></strong>
            </p>
            
            <div class="quran-page-container">
                <img 
                    src="https://post.walid-fekry.com/quran/<?= $randomQuranPage ?>.jpg" 
                    alt="صفحة قرآن <?= $randomQuranPage ?>"
                    class="quran-page-image"
                    loading="lazy"
                >
                
                <div class="audio-player mt-3">
                    <audio controls preload="none">
                        <source src="https://post.walid-fekry.com/quran/mp3/<?= $randomQuranPage ?>.mp3" type="audio/mpeg">
                    </audio>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center">
            ...
            <iframe 
                id="ruqyahFrame"
                src="https://post.walid-fekry.com/pdf/roquia.pdf" 
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <div class="share-buttons">
                ...
                <button 
                    class="share-btn share-copy copy-link-btn" 
